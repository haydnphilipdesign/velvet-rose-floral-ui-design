      ...
      >
        ...
        <div className="animate-item pt-8 border-t border-light-rose">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-muted-taupe text-sm">
              <p>© 2026 Velvet Rose. All rights reserved.</p>
              <p className="mt-1">
                Site by{' '}
                <a
                  ...
                  className="hover:text-coral transition-colors duration-300 underline underline-offset-2"
                >
                  Multimedium
                </a>
              </p>
